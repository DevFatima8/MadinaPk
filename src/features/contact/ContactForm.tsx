                                        ...
                                        <div className="col-xl-12">
                                            <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
                                                <button
                                                    ...
                                                    onMouseEnter={(e) => {
                                                        e.currentTarget.style.background = '#d69b02';
                                                        e.currentTarget.style.transform = 'translateY(-2px)';
                                                        e.currentTarget.style.boxShadow = '0 8px 25px rgba(236, 172, 2, 0.3)';
                                                    }}
                                                    onMouseLeave={(e) => {
                                                        e.currentTarget.style.background = '#ecac02';
                            ...
                            <div style={{
                                ...
                                <div style={{ marginBottom: '28px' }}>
                                    <h4 style={{
                                        ...
                                        <i className="fas fa-phone" style={{ color: '#ecac02', marginRight: '10px', width: '18px' }}></i>
                                        Pakistan Office
                                    </h4>
                                ...
                                <div style={{ marginBottom: '28px' }}>
                                    <h4 style={{
                                        ...
                                        <i className="fas fa-envelope" style={{ color: '#ecac02', marginRight: '10px', width: '18px' }}></i>
                                        Email Addresses
                                    </h4>
                                    <p style={{ color: '#585b6b', marginLeft: '28px', marginBottom: '4px' }}>
                                ...
                                <div style={{ marginBottom: '30px' }}>
                                    <h4 style={{
                                        ...
                                        <i className="fas fa-clock" style={{ color: '#ecac02', marginRight: '10px', width: '18px' }}></i>
                                        Working Hours
                                    </h4>
