                                    ...
                                    {categories.map((cat) => (
                                        <li key={cat}>
                                            <button
                                                ...
                                                style={{
                                                    padding: '10px 25px',
                                                    background: activeCategory === cat ? '#ecac02' : 'transparent',
                                                    color: activeCategory === cat ? '#fff' : '#062f3a',
                                                    border: activeCategory === cat ? '1px solid #ecac02' : '1px solid #e6e6e6',
                                                    borderRadius: '30px',
                                                    cursor: 'pointer',
                                                    fontSize: '15px',
                                    ...
                                    <div className="product-card" style={{
                                        ...
                                        <div className="product-card__image" style={{ position: 'relative', overflow: 'hidden' }}>
                                            ...
                                            <div style={{
                                                ...
                                                {product.condition.map((cond, i) => (
                                                    <span key={i} style={{
                                                        background: cond === 'New' ? '#198754' : '#ecac02',
                                                        color: '#fff',
                                                        padding: '4px 12px',
                                                        borderRadius: '20px',
                                                        fontSize: '12px',
                                        ...
                                        <div style={{ padding: '25px 25px 30px' }}>
                                            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '10px' }}>
                                                <span className={product.categoryIcon} style={{ color: '#ecac02', fontSize: '24px' }}></span>
